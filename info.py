...
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002134871596')
...
REQUESTS_CHANNEL = environ.get('REQUESTS_CHANNEL', '-1002134871596')
...
VERIFY_TUTORIAL = environ.get("VERIFY_TUTORIAL", "https://t.me/ML_Files/38")
...
SHORTLINK_API = environ.get("SHORTLINK_API", "b45f8f81a9b97173588484df25715cb97b4d3fb1")
...
# bot string settings
FORCE_SUB_CHANNELS = environ.get('FORCE_SUB_CHANNELS', '-1002918900365')  # For multiple channels, separate channel IDs with spaces. Example: "-100xxxxx -100xxxxx -100xxxxx"
REQUEST_FORCE_SUB_CHANNEL = environ.get('REQUEST_FORCE_SUB_CHANNEL', '-1002237171878')

# for stream
IS_STREAM = is_enabled('IS_STREAM', True)
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002134871596")
if len(BIN_CHANNEL) == 0:
    logger.error('BIN_CHANNEL is missing, exiting now')
    exit()
else:
    BIN_CHANNEL = int(BIN_CHANNEL)
URL = environ.get("URL", "https://movie-loverzz-bot5-18ba1d7592a6.herokuapp.com/")
if len(URL) == 0:
...
PAYMENT_QR_CODE = "https://i.ibb.co/PzWxvXTL/photo-2026-07-06-18-01-18-7659476772529897476.jpg" # add your payment qr code link, like upi qr code or any crypto qr code link
PAYMENT_ID = "movieloverz11220@okhdfcbank"  # add your payment id like upi id or crypto address
...
# for TMDb
TMDB_API_KEY = environ.get("TMDB_API_KEY", "1ba98a04426a253bc7cb4be687abe2ed")  # Get API key from here - https://www.themoviedb.org/settings/api
